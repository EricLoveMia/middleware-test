package com.loveprogramer.middleware.server;/**
 * Created by Administrator on 2019/3/29.
 */

import com.loveprogramer.middleware.server.dto.UserLoginDto;
import com.loveprogramer.middleware.server.entity.BloomDto;
import com.loveprogramer.middleware.server.entity.RMapDto;
import com.loveprogramer.middleware.server.entity.RSetComparator;
import com.loveprogramer.middleware.server.entity.RSetDto;
import com.loveprogramer.middleware.server.service.redisson.UserLoginPublisher;
import com.loveprogramer.middleware.server.service.redisson.delayQueue.MqDelayQueuePublisher;
...
public class RedissonTest {
    ...
    public void test2() throws Exception {
        ...
        log.info("该布隆过滤器是否包含数据10000：{}", bloomFilter.contains(1000));
    ...
    public void test9() throws Exception {
        ...
        // TODO
        Collection<RSetDto> resultB = rScoredSortedSet.readSortAlpha(SortOrder.ASC);
        log.info("此时得分排序集合ScoredSortedSet的元素列表-从小到大：{} ", resultB);
