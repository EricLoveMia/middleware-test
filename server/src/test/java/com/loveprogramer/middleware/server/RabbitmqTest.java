...
import com.loveprogramer.middleware.server.rabbitmq.entity.DeadInfo;
import com.loveprogramer.middleware.server.rabbitmq.entity.EventInfo;
import com.loveprogramer.middleware.server.rabbitmq.entity.KnowledgeInfo;
import com.loveprogramer.middleware.server.rabbitmq.entity.Person;
import com.loveprogramer.middleware.server.rabbitmq.publisher.*;
...
public class RabbitmqTest {
    ...
    public void test3() throws Exception {
        ...
        modelPublisher.sendMsgFanoutTwo("基于fanoutExchange的消息模型");
    }
