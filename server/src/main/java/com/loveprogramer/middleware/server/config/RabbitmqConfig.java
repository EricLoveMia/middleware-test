...
import com.loveprogramer.middleware.server.rabbitmq.consumer.KnowledgeManualConsumer;
...
public class RabbitmqConfig {
    ...
    /**
     * @MethodName: basicQueue
     * @Description: 创建队列
     * @Param: []
     * @Return: org.springframework.amqp.core.Queue
     * @Author: YCKJ2725
     * @Date: 2021/10/14 8:48
     **/
    @Bean(name = "basicQueue")
    public Queue basicQueue() {
        // duarable建议设置为true 重启后仍然不会丢失数据
